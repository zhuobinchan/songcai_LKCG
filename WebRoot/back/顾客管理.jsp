                ...
                <div class="row-fluid">
                    <div class="span12">
                         <div  class="daohanglink"style="">
                           ...
                           <span>顾客管理</span>
                           <a  href="<%=request.getContextPath()%>/songcai_net/CustomerNetAction_getAll.action" class="label label-warning" style="float:right; margin:8px;">添加</a>
                         </div>
                                ...
                                <table class="table table-striped table-bordered table-hover datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="10%">顾客ID</th>
                                            <th width="15%">顾客姓名</th>
                                            <th width="15%">顾客手机号码</th>
                                            <th width="15%">顾客头像</th>
                                            <th width="15%">顾客银行卡</th>                                          
                                            <th width="15%">管理操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><s:property value="#customer.customer_name"/></td>
                                            <td><s:property value="#customer.customer_telephone"/></td>
                                            <td><s:property value="#customer.customer_icon"/></td>
                                            <td><s:property value="#customer.customer_bank_card"/></td>
                                            <td>
