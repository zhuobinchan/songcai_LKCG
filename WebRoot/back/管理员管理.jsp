                ...
                <div class="row-fluid">
                    <div class="span12">
                         <div  class="daohanglink"style="">
                           ...
                           <span>管理员管理</span>
                           <a  href="<%=request.getContextPath()%>/songcai_net/AdministratorNetAction_getAll.action" class="label label-warning" style="float:right; margin:8px;">添加</a>
                         </div>
                        <div class="well brown">
                            ...
                            <div class="well-content" style="border:0px;">
                                <table class="table table-striped table-bordered table-hover datatable">
                                    ...
                                    <tbody>
                                    	<s:iterator value="administrators" id="administrator">
                                        <tr>
                                            <td><s:property value="#administrator.administrator_id"/></td>
                                            <td><s:property value="#administrator.administrator_name"/></td>
                                            <td>
