                ...
                <div class="row-fluid">
                    <div class="span12">
                         <div  class="daohanglink"style="">
                           ...
                           <span>订单管理</span>
                           <a  href="<%=request.getContextPath()%>/songcai_net/OrderNetAction_getAll.action" class="label label-warning" style="float:right; margin:8px;">添加</a>
                         </div>
                            ...
                            <div class="well-content" style="border:0px;">
                                <table class="table table-striped table-bordered table-hover datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><s:property value="#order.order_id"></s:property></td>
                                            <td><s:property value="#order.order_consignee"></s:property></td>
                                            <td><s:property value="#order.order_address"></s:property></td>
                                            <td><s:property value="#order.order_time"></s:property></td>
                                            <td><s:property value="#order.order_introduce"></s:property></td>
                                            <td><s:property value="#order.order_total_price"></s:property></td>
                                           	<td><s:property value="#order.order_state"></s:property></td>
                                           	<td><s:property value="#order.order_telephone"></s:property></td>
                                            <td>
