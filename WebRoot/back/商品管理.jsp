				...
				<div class="row-fluid">
					<div class="span12">
						<div class="daohanglink" style="">
							<span class="daohang"></span> <span>首页</span><span>></span> <span>商品管理</span>
							<a
								href="<%=request.getContextPath()%>/back/添加.jsp"
						...
						<div class="well brown">
							...
							<div class="well-content" style="border:0px;">
								<table
									...
									<tbody>
										<s:iterator value="commodities" id="commodity">
											<tr>
												<td><s:property value="#commodity.commodity_id" /></td>
												<td><s:property value="#commodity.commodity_name" /></td>
												<td><s:property value="#commodity.commodity_price" /></td>
												<td><s:property value="#commodity.commodity_introduce" /></td>
												<td><s:property
														value="#commodity.commodity_sales_volume" /></td>
												<td><s:property value="#commodity.ct.ct_name" /></td>
												<td><s:property value="#commodity.shop.shop_name" /></td>
