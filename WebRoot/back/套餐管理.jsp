				...
				<div class="row-fluid">
					<div class="span12">
						<div class="daohanglink" style="">
							<span class="daohang"></span> <span>首页</span><span>></span> <span>套餐管理</span>
							<a
								href="<%=request.getContextPath()%>/songcai_net/SetMealNetAction_getAll.action"
								class="label label-warning" style="float:right; margin:8px;">添加</a>
						</div>
						<div class="well brown">
							...
							<div class="well-content" style="border:0px;">
								<table
									...
									<tbody>
										<s:iterator value="setMeals" id="setMeal">
											<tr>
												<td><s:property value="#setMeal.setmeal_id"/></td>
												<td><s:property value="#setMeal.setmeal_introduce"/></td>
												<td><s:property value="#setMeal.setmeal_name"/></td>
												<td><s:property value="#setMeal.setmeal_date"/></td>
												<td><s:property value="#setMeal.setmeal_total_price"/></td>
												<td><s:property value="#setMeal.setmeal_sales_volume"/></td>
												<td><s:property value="#setMeal.administrator.administrator_name"/></td>
												<td><a class="btn" href="#" title="修改"><i
														class="icon-inbox"></i></a> <a class="btn" href="#" title="删除"><i
														class="icon-trash"></i></a> <a class="btn" href="#" title="查看"><i
														class="icon-exclamation"></i></a></td>
											</tr>
										</s:iterator>
