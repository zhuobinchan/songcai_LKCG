                ...
                <div class="row-fluid">
                    <div class="span12">
                         <div  class="daohanglink"style="">
                           ...
                           <span>档口管理</span>
                           <a  href="<%=request.getContextPath()%>/songcai_net/ShopNetAction_getAll.action" class="label label-warning" style="float:right; margin:8px;">添加</a>
                         </div>
                        <div class="well brown">
                            ...
                            <div class="well-content" style="border:0px;">
                                <table class="table table-striped table-bordered table-hover datatable">
                                    ...
                                    <tbody>
                                    	<s:iterator value="shops" id="shop">
                                        <tr>
                                            <td><s:property value="#shop.shop_id"/></td>
                                            <td><s:property value="#shop.shop_name"/></td>
                                            <td><s:property value="#shop.shop_introduce"/></td>
                                            <td><s:property value="#shop.shop_address"/></td>
                                            <td><s:property value="#shop.shop_icon"/></td>
                                            <td><s:property value="#shop.shop_telephone"/></td>
                                            <td><s:property value="#shop.shop_market"/></td>
                                            <td><s:property value="#shop.shop_type"/></td>
                                            <td>
